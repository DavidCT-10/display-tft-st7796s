...
void setup() {
  Serial.begin(9600);
  Serial.println("TFT ST7796S Test!"); 
  ...
  Serial.println(testFastLines(ST7796S_RED, ST7796S_BLUE));
  delay(500);
  ...
  Serial.println(testFilledRects(ST7796S_YELLOW, ST7796S_MAGENTA));
  delay(500);

  Serial.print(F("Circles (filled)         "));
  Serial.println(testFilledCircles(10, ST7796S_MAGENTA));

  Serial.print(F("Circles (outline)        "));
  Serial.println(testCircles(10, ST7796S_WHITE));
  delay(500);
