...
/**************************************************************************/
/*!
    @brief  Instantiate Display ST7796S driver with software SPI
...
*/
/**************************************************************************/
Display_ST7796S::Display_ST7796S(int8_t cs, int8_t dc, int8_t mosi,
...
/**************************************************************************/
/*!
    @brief  Instantiate Display ST7796S driver with hardware SPI using the
...
*/
/**************************************************************************/
Display_ST7796S::Display_ST7796S(int8_t cs, int8_t dc, int8_t rst)
    : Adafruit_SPITFT(ST7796S_TFTWIDTH, ST7796S_TFTHEIGHT, cs, dc, rst) {}

#if !defined(ESP8266)
/**************************************************************************/
/*!
    @brief  Instantiate Display ST7796S driver with hardware SPI using
...
*/
/**************************************************************************/
Display_ST7796S::Display_ST7796S(SPIClass *spiClass, int8_t dc, int8_t cs,
                                   int8_t rst)
...
/**************************************************************************/
/*!
    @brief  Instantiate Display ST7796S driver using parallel interface.
...
*/
/**************************************************************************/
Display_ST7796S::Display_ST7796S(tftBusWidth busWidth, int8_t d0, int8_t wr,
...
static const uint8_t PROGMEM initcmd[] = {
  ...
  0xF7, 1, 0x20,
  0xEA, 2, 0x00, 0x00,
  ST7796S_PWCTR1  , 1, 0x23,             // Power control VRH[5:0]
  ST7796S_PWCTR2  , 1, 0x10,             // Power control SAP[2:0];BT[3:0]
  ST7796S_VMCTR1  , 2, 0x3e, 0x28,       // VCM control
  ST7796S_VMCTR2  , 1, 0x86,             // VCM control2
  ST7796S_MADCTL  , 1, 0x48,             // Memory Access Control
  ST7796S_VSCRSADD, 1, 0x00,             // Vertical scroll zero
  ST7796S_PIXFMT  , 1, 0x55,
  ST7796S_FRMCTR1 , 2, 0x00, 0x18,
  ST7796S_DFUNCTR , 3, 0x08, 0x82, 0x27, // Display Function Control
  0xF2, 1, 0x00,                         // 3Gamma Function Disable
  ST7796S_GAMMASET , 1, 0x01,             // Gamma curve selected
  ST7796S_GMCTRP1 , 15, 0x0F, 0x31, 0x2B, 0x0C, 0x0E, 0x08, // Set Gamma
    0x4E, 0xF1, 0x37, 0x07, 0x10, 0x03, 0x0E, 0x09, 0x00,
  ST7796S_GMCTRN1 , 15, 0x00, 0x0E, 0x14, 0x03, 0x11, 0x07, // Set Gamma
...
*/
/**************************************************************************/
void Display_ST7796S::begin(uint32_t freq) {
...
*/
/**************************************************************************/
void Display_ST7796S::setRotation(uint8_t m) {
...
*/
/**************************************************************************/
void Display_ST7796S::invertDisplay(bool invert) {
...
*/
/**************************************************************************/
void Display_ST7796S::scrollTo(uint16_t y) {
  uint8_t data[2];
  data[0] = y >> 8;
  data[1] = y & 0xff;
 ...
 */
/**************************************************************************/
void Display_ST7796S::setScrollMargins(uint16_t top, uint16_t bottom) {
...
*/
/**************************************************************************/
void Display_ST7796S::setAddrWindow(uint16_t x1, uint16_t y1, uint16_t w,
                                     uint16_t h) {
  ...
  if (y1 != old_y1 || y2 != old_y2) {
    writeCommand(ST7796S_RASET); // Row address set
    SPI_WRITE16(y1);
    SPI_WRITE16(y2);
    old_y1 = y1;
    old_y2 = y2;
 ...
 */
/**************************************************************************/
uint8_t Display_ST7796S::readcommand8(uint8_t commandByte, uint8_t index) {
